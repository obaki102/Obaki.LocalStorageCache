...
The purpose of me implementing data protection is to give an option to encrypt your cache data in local storage. But this is not in any form will make your cache data secure. Highly sensitive and confidential data should always be stored server side.
